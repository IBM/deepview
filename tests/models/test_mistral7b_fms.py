...
def model_output_file(tmp_path_factory):
    """
    Fixture that returns 'test_mistral7b_output.txt' generated by model runner.
    """

    return tmp_path_factory.getbasetemp() / "test_mistral7b_output.txt"
...
def test_layer_debugging_mode(model_output_file, request):
    ...
    Args:
        model_output_file: A fixture that uses the test_mistral7b_output.txt file generated by the model runner.
